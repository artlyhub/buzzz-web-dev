...
def main(start_path):
    ...
    #코스피 회사명, 회사코드, 종목 저장
    kos.companies(start_path + '/data/' + date + '_kospi_industry.txt', date, kospiCompanyCode, "KP")
    ...
    #코스닥 회사명, 회사코드, 종목 저장
    kos.companies(start_path + '/data/' + date + '_kosdaq_industry.txt', date, kosdaqCompanyCode, "KD")
